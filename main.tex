...
systems such as scale-out storages and data-parallel computing frameworks.
...
revenue each year from service downtimes, yet there are many challenges to
reach an ideal dependability. It is challenging, because the cloud back ends
are complex, they are written in millions of lines of code that are brittle and
prone to failures.
...
'13}, researchers from NEC Labs dissected network-failure-related DC bugs to
study, but they did not cover other types of DC bugs and not publicly release it.
Additionally, I am not aware of any complete DC-bug studies published. 
...
contains in-depth characteristics of DC bugs, stored in the form of 2083
...
dependability that the system community has not paid attention. A journey
toward the goal is a long road, but I believe my research advances system
